...
def PCA_2D():
    ...
    plt.savefig("img/PCA_2Dnc2.png")
    plt.show()

    #np.savetxt("dataRidotto.csv", X_pca, delimiter=",")
    pd.DataFrame(X_pca).to_csv("dataRidotto.csv")
...
def PCA_component_interpretation():
    ...
    #data_components = pd.DataFrame(components)
    #print(data_components.to_latex())
    """
    for i in range(0, len(components)):
...
def kernelPCA_2D():
    ...
    plt.xlabel("Prima componente principale")
    plt.ylabel("Seconda componente principale")
    plt.savefig("img/kernelPCA_2Dnc2.png")
    plt.show()
...
def kernelPCA_2D_with_size():
    ...
    plt.xlabel("Prima componente principale")
    plt.ylabel("Seconda componente principale")
    plt.savefig("img/kernelPCA_2Dnc3.png")
    plt.show()
...
def kernelPCA_i3D():
    ...
    ax.set_ylabel("Seconda componente principale")
    ax.set_zlabel("Terza componente principale")
    plt.savefig("img/kernelPCA_i3D.png")
    plt.show()
...
def kernelPCA_SPLOM(n_params):
    ...
    sns.set(style="ticks")
    sns.pairplot(dataframe, hue="Class", palette={"Non Celiaco": blue, "Celiaco": yellow}, plot_kws=dict(edgecolor=edgecolors, linewidth=linewidth, alpha=alpha))
    plt.savefig("img/kernelPCA_SPLOM.png")
    plt.show()
...
def tSNE_2D_with_size():
    ...
    plt.xlabel("Prima Componente")
    plt.ylabel("Seconda Componente")
    plt.savefig("img/tSNE_2Dnc3.png")
    plt.show()
...
def tSNE_SPLOM(n_params):
    ...
    sns.set(style="ticks")
    sns.pairplot(dataframe, hue="Class", palette={"Non Celiaco": blue, "Celiaco": yellow}, plot_kws=dict(edgecolor=edgecolors, linewidth=linewidth, alpha=alpha))
    plt.savefig("img/tSNE_SPLOM.png")
    plt.show()
